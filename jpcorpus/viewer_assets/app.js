...
const text = {
  zh: {
    ...
    studyKnown: "已经会了",
    studyMastered: "已记住",
    studyChecks: "进度 {count}/{target}",
    studyCheckButton: "记一次 +1",
    studyHint: "先复习到期的词，再补新词；今天见过就记一次，满 7 次算记住。",
    studyReview: "复习",
    studyNew: "新词",
    shows: "作品",
    subtitles: "字幕",
  ...
  en: {
    ...
    studyChecks: "Progress {count}/{target}",
    studyCheckButton: "Review +1",
    studyHint: "Review due words first, then fill with new words. Seven reviews means mastered.",
    studyReview: "Review",
    studyNew: "New",
    shows: "Shows",
    subtitles: "Subtitles",
