window.JPCORPUS_TEXT = {
  zh: {
    ...
    dictionaryFile: "词典文件",
    dictionaryName: "显示名称",
    dictionaryNamePlaceholder: "可留空，自动使用词典标题",
    dictionaryImport: "导入",
  ...
  en: {
    ...
    dictionaryNamePlaceholder: "Optional; uses the dictionary title",
    ...
    dictionaryHeadwords: "{count} headwords",
