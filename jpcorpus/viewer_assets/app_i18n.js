window.JPCORPUS_TEXT = {
  zh: {
    ...
    dictionaryAuditTitle: "词典质量",
    dictionaryAuditHelp: "临时检查词典覆盖和高频可疑词，方便我们继续修数据。",
    dictionaryAuditRefresh: "重新扫描",
    dictionaryAuditLoading: "正在扫描词典质量…",
    dictionaryAuditFailed: "扫描失败：{error}",
    dictionaryAuditEmpty: "打开维护面板后会自动扫描，也可以手动重新扫描。",
    dictionaryAuditNoIssues: "暂时没看到问题",
    dictionaryAuditTotal: "词",
    dictionaryAuditWithChinese: "有中文",
    dictionaryAuditMissingChinese: "缺中文",
    dictionaryAuditWithJmdict: "有 JMdict",
    dictionaryAuditNoJmdict: "无 JMdict",
    dictionaryAuditWithExamples: "有词典例句",
    dictionaryAuditMissingZhTitle: "缺中文",
    dictionaryAuditMissingZhHelp: "优先看高频词；这些可能需要更好的中文词源或人工 override。",
    dictionaryAuditEnglishOnlyTitle: "英文 fallback",
    dictionaryAuditEnglishOnlyHelp: "有英文义项但没有中文释义，学习时最容易显得不一致。",
    dictionaryAuditNoJmdictTitle: "无 JMdict",
    dictionaryAuditNoJmdictHelp: "可能是人名、作品词、分词残片，或者词典确实没收。",
    dictionaryAuditNoExamplesTitle: "无词典例句",
    dictionaryAuditNoExamplesHelp: "JMdict 有义项但没有离线词典例句；语料例句仍然可能存在。",
    dictionaryAuditRawPosTitle: "词性未清理",
    dictionaryAuditRawPosHelp: "这里出现英文长标签时，说明需要补一条词性映射。",
  ...
  en: {
    ...
    dictionaryAuditTitle: "Dictionary quality",
    dictionaryAuditHelp: "Temporary coverage checks for high-frequency suspicious entries.",
    dictionaryAuditRefresh: "Scan again",
    dictionaryAuditLoading: "Scanning dictionary quality...",
    dictionaryAuditFailed: "Scan failed: {error}",
    dictionaryAuditEmpty: "The scan starts when Maintenance opens. You can also scan manually.",
    dictionaryAuditNoIssues: "No issues here",
    dictionaryAuditTotal: "Words",
    dictionaryAuditWithChinese: "ZH",
    dictionaryAuditMissingChinese: "Missing ZH",
    dictionaryAuditWithJmdict: "JMdict",
    dictionaryAuditNoJmdict: "No JMdict",
    dictionaryAuditWithExamples: "Dict examples",
    dictionaryAuditMissingZhTitle: "Missing Chinese",
    dictionaryAuditMissingZhHelp: "Start with high-frequency words; these may need a better Chinese source or an override.",
    dictionaryAuditEnglishOnlyTitle: "English fallback",
    dictionaryAuditEnglishOnlyHelp: "Entries with English glosses but no Chinese meaning.",
    dictionaryAuditNoJmdictTitle: "No JMdict",
    dictionaryAuditNoJmdictHelp: "Often names, media-specific terms, tokenization leftovers, or words absent from JMdict.",
    dictionaryAuditNoExamplesTitle: "No dictionary examples",
    dictionaryAuditNoExamplesHelp: "JMdict has senses, but no offline dictionary examples. Corpus examples may still exist.",
    dictionaryAuditRawPosTitle: "Raw POS labels",
    dictionaryAuditRawPosHelp: "Long English grammar labels here mean the POS mapping needs another cleanup rule.",
