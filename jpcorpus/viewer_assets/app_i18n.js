window.JPCORPUS_TEXT = {
  zh: {
    ...
    maintenanceTaskFetchLexicalResources: "下载 JMdict；之后点“刷新语料”才会出现在页面里",
  ...
  en: {
    ...
    maintenanceTaskFetchLexicalResources: "Downloads JMdict; refresh the corpus afterwards to show it",
