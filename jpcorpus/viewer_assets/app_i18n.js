window.JPCORPUS_TEXT = {
  zh: {
    ...
    ttsTitle: "朗读",
    ttsHelp: "默认使用浏览器日语语音；如果本机开着 VOICEVOX engine，可以切到 VOICEVOX。",
    ...
    importTextHelp: "只有文本必填；标题和 URL 只是用来之后识别来源。",
    ...
    importTextRefreshFailed: "已保存，但刷新失败：{error}",
  ...
  en: {
    ...
    ttsTitle: "Read aloud",
    ttsHelp: "Browser Japanese voices are used by default. If a local VOICEVOX engine is running, you can switch to VOICEVOX.",
    ...
    importTextHelp: "Only text is required. Title and URL are just source metadata.",
    ...
    importTextRefreshFailed: "Saved, but refresh failed: {error}",
