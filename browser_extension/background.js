...
const MESSAGES = {
  zh: {
    menuImportSelection: "导入选中文字到日语阅读助手",
    menuImportArticle: "导入正文到日语阅读助手",
    menuToggleReader: "切换日语阅读助手网页阅读模式",
    noSelection: "没有选中文字可导入。",
    importingToJpcorpus: "正在导入日语阅读助手...",
    alreadyImported: "已经导入过 {title}，无需刷新。",
    imported: "已导入 {title}。",
    importFailedTitle: "日语阅读助手导入失败",
    readerFailedTitle: "日语阅读助手网页阅读模式失败",
    readingMode: "网页阅读模式",
    studyUpdate: "学习状态更新",
    importAction: "导入",
  ...
  en: {
    menuImportSelection: "Add selection to Japanese Reading Companion",
    menuImportArticle: "Add main article to Japanese Reading Companion",
    menuToggleReader: "Toggle Japanese Reading Companion reading mode",
    noSelection: "No selected text to import.",
    importingToJpcorpus: "Importing to Japanese Reading Companion...",
    alreadyImported: "Already imported {title}. No refresh needed.",
    imported: "Imported {title}.",
    importFailedTitle: "Japanese Reading Companion import failed",
    readerFailedTitle: "Japanese Reading Companion reading mode failed",
